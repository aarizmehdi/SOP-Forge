        ...
        if (!reviews || reviews.length === 0) {
            container.innerHTML = `
                <div style="text-align:center; padding: 40px 20px; color:var(--text-secondary);">
                    ...
                    <p style="font-size:var(--text-md); font-weight: 500;">All caught up!</p>
                    <p style="font-size:var(--text-sm); margin-top: 4px;">There are no team requests requiring your approval right now.</p>
                </div>
            `;
            return;
        }
